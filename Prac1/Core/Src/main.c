...
/* USER CODE BEGIN 0 */
unint8_t numPin= 8;
void displayPattern(uint8_t idx){

	for (int i = 0; i < 9; i++) {
	    // Set the LEDs according to the current pattern
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0, patterns[i][0]);
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, patterns[i][1]);
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2, patterns[i][2]);
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, patterns[i][3]);
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, patterns[i][4]);
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, patterns[i][5]);
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_6, patterns[i][6]);
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, patterns[i][7]);
	}
